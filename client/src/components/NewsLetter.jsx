  ...
  return (
    <div className='flex flex-col items-center justify-center text-center my-32 space-y-2'>
        ...
        <form className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
            <input type="email" placeholder='Enter your email id' required className='border border-gray-300 rounded-md h-full border-r-0 outline-none w-full rounded-r-none text-gray-500'/>
