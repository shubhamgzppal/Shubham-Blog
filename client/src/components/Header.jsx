    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500'>
                ...
                whether it's one word or a thousand, your stoery right here.
            </p>
            ...
            <form onSubmit={onSubmitHandler} className='flex justify-center max-w-lg max-sm:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>
                ...
                <button type='submit' className='bg-primary text-white px-4 py-2 m-1.5 rounded hover:scale-105 transition-all cursor-pointer'>Search</button>
            </form>

        </div>
        <div className='text-center'>
           {input && <button onClick={onClear} className='border font-light text-xs py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer'>Clear Serach</button>}
        </div>
